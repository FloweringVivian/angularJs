...
//集成rest接口
config.integrateUrl = "http://172.31.10.109:8888";
...
config.ossUploadUrl = "http://172.31.10.168:8888/oss/upload/extrupload";
config.viewPath = "/zhl/views/";
config.controllerPath = "/zhl/engine/controllers/";
config.inviteUser = "http://172.31.10.180/";
config.payGateWay = 'https://testpay.justsharecloud.com/pay/gateway.php';
